...
namespace SmartApiary.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260610171940_AddSpatialGeographyLocations")]
    partial class AddSpatialGeographyLocations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartApiary.Domain.Models.HiveInspectionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("HiveInspectionRecords", (string)null);
                });
            ...
            modelBuilder.Entity("SmartApiary.Domain.Models.Apiary", b =>
                {
                    b.HasOne("SmartApiary.Domain.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SmartApiary.Domain.Models.Device", b =>
                {
                    b.HasOne("SmartApiary.Domain.Models.Hive", null)
                        .WithOne()
                        .HasForeignKey("SmartApiary.Domain.Models.Device", "HiveId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SmartApiary.Domain.Models.Hive", b =>
                {
                    b.HasOne("SmartApiary.Domain.Models.Apiary", null)
                        .WithMany()
                        .HasForeignKey("ApiaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SmartApiary.Domain.Models.UserAlertSettings", b =>
                {
                    b.HasOne("SmartApiary.Domain.Models.User", null)
                        .WithOne()
                        .HasForeignKey("SmartApiary.Domain.Models.UserAlertSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
